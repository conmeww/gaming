...
*/
        ...
        if (showMoreProducts || false) showMoreProducts.addEventListener("click", (() => {
            ...
            if (0 === hiddenElements.length) showMoreProducts.className = "d-none";
        }));
        ...
        for (var i = 0; i < removeCartItemButtons.length; i++) {
            ...
            button.addEventListener("click", (function(event) {
                ...
                for (var i = 0; i < cartItemsNames.length; i++) if (cartItemsNames[i].src == getImageSrc) cartItemsNames[i].parentElement.parentElement.remove();
